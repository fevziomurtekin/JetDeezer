...
import com.fevziomurtekin.deezerclonecompose.core.mapper.RoomMapper
...
@Database(entities = [GenreEntity::class, SearchEntity::class, AlbumEntity::class], version = DEEZER_DATABASE_VERSION, exportSchema = false)
@TypeConverters(value = [RoomMapper::class])
